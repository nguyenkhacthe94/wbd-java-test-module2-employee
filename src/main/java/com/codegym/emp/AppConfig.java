...
@EnableJpaRepositories("com.codegym.emp.repository")
@ComponentScan("com.codegym.emp")
@ComponentScan("com.codegym.emp.validation")
...
public class AppConfig extends WebMvcConfigurerAdapter implements ApplicationContextAware {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        em.setPackagesToScan("com.codegym.emp.model");
